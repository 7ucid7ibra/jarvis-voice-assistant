...
def profile_file_paths(profile: str, base_dir: str | None = None) -> Tuple[str, str]:
    """
    Return memory/history file paths for a profile.
    """
    base_dir = base_dir or app_paths.data_root()
...
def remove_profile_files(profile: str, base_dir: str | None = None) -> Dict[str, bool]:
    """
